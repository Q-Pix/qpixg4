...
class ConfigManager {
  public:
    ...
    static G4String      GetDetectorConfiguration()         { return Instance()->detectorConfiguration_; }
    ...
    static void SetDetectorConfiguration(G4String value)    { Instance()->detectorConfiguration_ = value; }
